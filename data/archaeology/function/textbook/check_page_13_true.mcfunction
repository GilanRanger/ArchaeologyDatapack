# Check function for page 13 (True clicked)
            # Reset tag counter
            ...
            execute if score @s tagCheck matches 1.. if score @s textbook_q13 matches 0 run scoreboard players add @s textbook_correct 1
            execute if score @s tagCheck matches 1.. if score @s textbook_q13 matches 0 run scoreboard players set @s textbook_q13 1
