...
execute if block 15 -60 11 minecraft:hopper{Items:[{components:{"minecraft:custom_data":{tag:2}}}]} run scoreboard players add @s tagCheck 1
            ...
            execute if score @s tagCheck matches 2.. if score @s textbook_q3 matches 0 run scoreboard players add @s textbook_correct 1
            execute if score @s tagCheck matches 2.. if score @s textbook_q3 matches 0 run scoreboard players set @s textbook_q3 1
