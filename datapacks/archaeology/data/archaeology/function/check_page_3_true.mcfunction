...
execute if score @s tagCheck matches 2.. run function archaeology:answer_incorrect
execute unless score @s tagCheck matches 2.. run function archaeology:answer_incorrect